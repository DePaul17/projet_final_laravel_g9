...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{asset('src/assets/images/logos/logotaskeasy.png')}}" />
  </head>
  <body>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="http://127.0.0.1:8000/redirects#auth">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="http://127.0.0.1:8000/wp-admin/pages/charts">
              <span class="menu-icon">
